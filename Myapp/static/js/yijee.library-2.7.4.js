    ...
    if (!d.ui.version) {
        ...
        function(f, c) {
            ...
            d.fn["inner" + c] = function(e) {
                ...
                return this.each(function() {
                    d(this).css(k, m(this, e) + "px");
                });
            };
            d.fn["outer" + c] = function(h, e) {
                if (typeof h !== "number") {
                    return j["outer" + c].call(this, h);
                }
                return this.each(function() {
                    d(this).css(k, m(this, h, true, e) + "px");
                });
            };
        });
        d.extend(d.expr[":"], {
        ...
        d(function() {
            var e = document.body,
            c = e.appendChild(c = document.createElement("div"));
            d.extend(c.style, {
                minHeight: "100px",
                height: "auto",
                padding: 0,
        ...
        d.extend(d.ui, {
            plugin: {
                add: function(f, c, i) {
                    ...
                    for (var h in i) {
                        ...
                        f.plugins[h].push([c, i[h]]);
                    }
                },
                call: function(f, c, i) {
                    if ((c = f.plugins[c]) && f.element[0].parentNode) {
                        for (var h = 0; h < c.length; h++) {
                            f.options[c[h][0]] && c[h][1].apply(f.element, i);
                        }
                    }
                }
            },
            ...
            isOver: function(f, c, m, l, k, j) {
                return d.ui.isOverAxis(f, m, k) && d.ui.isOverAxis(c, l, j);
            }
        });
    }
})(jQuery);
...
(function(a, e) {
    ...
    a.widget = function(b, k, j) {
        ...
        k = new k;
        k.options = a.extend(true, {},
        k.options);
        a[i][b].prototype = a.extend(true, k, {
            namespace: i,
            widgetName: b,
    ...
    a.Widget.prototype = {
        ...
        _trigger: function(b, k, j) {
            ...
            if (k.originalEvent) {
                ...
                for (var h; b;) {
                    h = a.event.props[--b];
                    k[h] = k.originalEvent[h];
                }
            }
            this.element.trigger(k, j);
            return ! (a.isFunction(i) && i.call(this.element[0], k, j) === false || k.isDefaultPrevented());
        }
    };
})(jQuery);
/*!
...
(function(a) {
    a.widget("ui.mouse", {
        ...
        _mouseDown: function(d) {
            ...
            if (!d.originalEvent.mouseHandled) {
                ...
                var c = this,
                i = d.which == 1,
                h = typeof this.options.cancel == "string" ? a(d.target).parents().add(d.target).filter(this.options.cancel).length: false;
                if (!i || h || !this._mouseCapture(d)) {
                    return true;
                }
    ...
    f.fn.position = function(c) {
        ...
        function() {
            var h = (c[this] || "").split(" ");
            if (h.length === 1) {
                h = e.test(h[0]) ? h.concat(["center"]) : d.test(h[0]) ? ["center"].concat(h) : ["center", "center"];
            }
        ...
        return this.each(function() {
            ...
            j = parseInt(f.curCSS(this, "marginTop", true)) || 0,
            z = t + k + (parseInt(f.curCSS(this, "marginRight", true)) || 0),
            y = s + j + (parseInt(f.curCSS(this, "marginBottom", true)) || 0),
            u = f.extend({},
            m),
            h;
            if (c.my[0] === "right") {
    ...
    a.widget("ui.sortable", a.ui.mouse, {
        ...
        _mouseCapture: function(h, d) {
            ...
            if (a.data(h.target, "sortable-item") == j) {
                k = a(h.target);
            }
            if (!k) {
                return false;
        ...
        _mouseStart: function(f, d, i) {
            ...
            if (!i) {
                for (i = this.containers.length - 1; i >= 0; i--) {
                    this.containers[i]._trigger("activate", f, h._uiHash(this));
                }
            }
            if (a.ui.ddmanager) {
        ...
        _mouseDrag: function(h) {
            ...
            if (this.options.scroll) {
                ...
                k = false;
                if (this.scrollParent[0] != document && this.scrollParent[0].tagName != "HTML") {
                    if (this.overflowOffset.top + this.scrollParent[0].offsetHeight - h.pageY < d.scrollSensitivity) {
                        this.scrollParent[0].scrollTop = k = this.scrollParent[0].scrollTop + d.scrollSpeed;
                    } else {
                        if (h.pageY - this.overflowOffset.top < d.scrollSensitivity) {
                            this.scrollParent[0].scrollTop = k = this.scrollParent[0].scrollTop - d.scrollSpeed;
                        }
                    }
                    if (this.overflowOffset.left + this.scrollParent[0].offsetWidth - h.pageX < d.scrollSensitivity) {
                        this.scrollParent[0].scrollLeft = k = this.scrollParent[0].scrollLeft + d.scrollSpeed;
                    } else {
                        if (h.pageX - this.overflowOffset.left < d.scrollSensitivity) {
                            this.scrollParent[0].scrollLeft = k = this.scrollParent[0].scrollLeft - d.scrollSpeed;
                        }
                    }
                } else {
                    if (h.pageY - a(document).scrollTop() < d.scrollSensitivity) {
                        k = a(document).scrollTop(a(document).scrollTop() - d.scrollSpeed);
                    } else {
                        if (a(window).height() - (h.pageY - a(document).scrollTop()) < d.scrollSensitivity) {
                            k = a(document).scrollTop(a(document).scrollTop() + d.scrollSpeed);
                        }
                    }
                    if (h.pageX - a(document).scrollLeft() < d.scrollSensitivity) {
                        k = a(document).scrollLeft(a(document).scrollLeft() - d.scrollSpeed);
                    } else {
                        if (a(window).width() - (h.pageX - a(document).scrollLeft()) < d.scrollSensitivity) {
                            k = a(document).scrollLeft(a(document).scrollLeft() + d.scrollSpeed);
                        }
                    }
                }
                k !== false && a.ui.ddmanager && !d.dropBehaviour && a.ui.ddmanager.prepareOffsets(this, h);
            }
            this.positionAbs = this._convertPositionTo("absolute");
            ...
            for (d = this.items.length - 1; d >= 0; d--) {
                ...
                if (i) {
                    if (j != this.currentItem[0] && this.placeholder[i == 1 ? "next": "prev"]()[0] != j && !a.ui.contains(this.placeholder[0], j) && (this.options.type == "semi-dynamic" ? !a.ui.contains(this.element[0], j) : true)) {
        ...
        _intersectsWithSides: function(f) {
            ...
            return this.floating && h ? h == "right" && f || h == "left" && !f: i && (i == "down" && d || i == "up" && !d);
        },
        ...
        refreshPositions: function(f) {
            ...
            for (var d = this.items.length - 1; d >= 0; d--) {
                var i = this.items[d],
                h = this.options.toleranceElement ? a(this.options.toleranceElement, i.item) : i.item;
                if (!f) {
                    i.width = h.outerWidth();
                    i.height = h.outerHeight();
                }
                h = h.offset();
                i.left = h.left;
                i.top = h.top;
        ...
        _createPlaceholder: function(f) {
            ...
            if (!i.placeholder || i.placeholder.constructor == String) {
                ...
                i.placeholder = {
                    element: function() {
                        var b = a(document.createElement(d.currentItem[0].nodeName)).addClass(h || d.currentItem[0].className + " ui-sortable-placeholder").removeClass("ui-sortable-helper")[0];
                        if (!h) {
            ...
            d.placeholder = a(i.placeholder.element.call(d.element, d.currentItem));
            d.currentItem.after(d.placeholder);
            i.placeholder.update(d, d.placeholder);
        },
        ...
        _convertPositionTo: function(f, d) {
            ...
            return {
                top: d.top + this.offset.relative.top * f + this.offset.parent.top * f - (a.browser.safari && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : h ? 0 : i.scrollTop()) * f),
                left: d.left + this.offset.relative.left * f + this.offset.parent.left * f - (a.browser.safari && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : h ? 0 : i.scrollLeft()) * f)
            };
        },
        ...
        _clear: function(f, d) {
            ...
            var i = []; ! this._noFinalSort && this.currentItem[0].parentNode && this.placeholder.before(this.currentItem);
            ...
            this.fromOutside && !d && i.push(function(b) {
            ...
            if (!a.ui.contains(this.element[0], this.currentItem[0])) {
                ...
                for (h = this.containers.length - 1; h >= 0; h--) {
                    if (a.ui.contains(this.containers[h].element[0], this.currentItem[0]) && !d) {
                        i.push(function(b) {
                            return function(c) {
...
jQuery.cookie = function(l, m, i) {
    if (typeof m != "undefined") {
        ...
        if (i.expires && (typeof i.expires == "number" || i.expires.toUTCString)) {
            if (typeof i.expires == "number") {
                h = new Date;
                h.setTime(h.getTime() + i.expires * 24 * 60 * 60 * 1000);
            } else {
                h = i.expires;
            }
            h = "; expires=" + h.toUTCString();
        }
        var k = i.path ? "; path=" + i.path: "",
        j = i.domain ? "; domain=" + i.domain: "";
        i = i.secure ? "; secure": "";
        document.cookie = [l, "=", encodeURIComponent(m), h, k, j, i].join("");
    } else {
        m = null;
        if (document.cookie && document.cookie != "") {
            ...
            for (h = 0; h < i.length; h++) {
                k = jQuery.trim(i[h]);
                if (k.substring(0, l.length + 1) == l + "=") {
                    m = decodeURIComponent(k.substring(l.length + 1));
                    break;
                }
            }
        }
    ...
    a.fn.extend({
        elastic: function() {
            ...
            return this.each(function() {
                function m(c, d) {
                    curratedHeight = Math.floor(parseInt(c, 10));
                    f.height() != curratedHeight && f.css({
                ...
                function l() {
                    ...
                    if (c + "&nbsp;" != d) {
                        p.html(c + "&nbsp;");
                        if (Math.abs(p.height() - f.height()) > 0) {
                            c = p.height();
                            if (c >= n) {
                                m(n, "auto");
                            } else {
                                c <= i ? m(i, "hidden") : m(c, "hidden");
                            }
                        }
                    }
                }
                ...
                o = parseInt(f.css("line-height"), 10) || parseInt(f.css("font-size"), "10"),
                i = parseInt(f.css("height"), 10) || o * 3,
                n = parseInt(f.css("max-height"), 10) || Number.MAX_VALUE;
                o = 0;
                if (n < 0) {
                    n = Number.MAX_VALUE;
                }
                p.appendTo(f.parent());
                for (o = b.length; o--;) {
                    p.css(b[o].toString(), f.css(b[o].toString()));
                }
                f.css({
                    overflow: "hidden"
                });
    ...
    a.fn.extend({
        outerHTML: function(c) {
            if (typeof c === "string") {
                ...
                return a("<div />").append(a(this).clone()).html();
            }
        }
    });
})(jQuery);
jQuery.expr[":"].containsNoCase = function(c, d, b) {
    return jQuery(c).text().toLowerCase().indexOf(b[3].toLowerCase()) >= 0;
};
jQuery.expr[":"].urlContainsNoCase = function(c, d, b) {
    return jQuery(c).attr("href").toLowerCase().indexOf(b[3].toLowerCase()) >= 0;
};
function SHA1(D) {
    function w(a, b) {
        return a << b | a >>> 32 - b;
    ...
    function n(b) {
        ...
        a;
        for (a = 7; a >= 0; a--) {
            c += (b >>> a * 4 & 15).toString(16);
        }
        return c;
    }
    var F, C, z = new Array(80),
    m = 1732584193,
    l = 4023233417,
    I = 2562383102,
    H = 271733878,
    ...
    var v = [];
    for (F = 0; F < E - 3; F += 4) {
        C = D.charCodeAt(F) << 24 | D.charCodeAt(F + 1) << 16 | D.charCodeAt(F + 2) << 8 | D.charCodeAt(F + 3);
        v.push(C);
    }
    switch (E % 4) {
    case 0:
        ...
        break;
    case 1:
        F = D.charCodeAt(E - 1) << 24 | 8388608;
        break;
    case 2:
        F = D.charCodeAt(E - 2) << 24 | D.charCodeAt(E - 1) << 16 | 32768;
        break;
    case 3:
        F = D.charCodeAt(E - 3) << 24 | D.charCodeAt(E - 2) << 16 | D.charCodeAt(E - 1) << 8 | 128;
        break;
    }
    for (v.push(F); v.length % 16 != 14;) {
        v.push(0);
    }
    v.push(E >>> 29);
    v.push(E << 3 & 4294967295);
    for (D = 0; D < v.length; D += 16) {
        for (F = 0; F < 16; F++) {
            z[F] = v[D + F];
        }
        for (F = 16; F <= 79; F++) {
            z[F] = w(z[F - 3] ^ z[F - 8] ^ z[F - 14] ^ z[F - 16], 1);
        }
        C = m;
        E = l;
        B = I;
        ...
        y = G;
        for (F = 0; F <= 19; F++) {
            x = w(C, 5) + (E & B | ~E & A) + y + z[F] + 1518500249 & 4294967295;
            y = A;
            A = B;
            B = w(E, 30);
            E = C;
        ...
        for (F = 20; F <= 39; F++) {
            x = w(C, 5) + (E ^ B ^ A) + y + z[F] + 1859775393 & 4294967295;
            y = A;
            A = B;
            B = w(E, 30);
            E = C;
        ...
        for (F = 40; F <= 59; F++) {
            x = w(C, 5) + (E & B | E & A | B & A) + y + z[F] + 2400959708 & 4294967295;
            y = A;
            A = B;
            B = w(E, 30);
            E = C;
        ...
        for (F = 60; F <= 79; F++) {
            x = w(C, 5) + (E ^ B ^ A) + y + z[F] + 3395469782 & 4294967295;
            y = A;
            A = B;
            B = w(E, 30);
            E = C;
    ...
    x = n(m) + n(l) + n(I) + n(H) + n(G);
    return x.toLowerCase();
}
function customLen(b) {
    return b.match(/[^\r|\n| -~]/g) === null ? b.replace(/[\r|\n]/g, "").length: b.replace(/[\r|\n]/g, "").length + b.match(/[^\r|\n| -~]/g).length;
}
function showError(b) {
    if (b == "" || b == "undefined") {
        b = "\u7f51\u7edc\u9519\u8bef";
    }
    $("#saveFail").text(b).fadeIn("slow");
    setTimeout(function() {
...
function noSession() {
    $("#saveFail").text("\u4f1a\u8bdd\u8fc7\u671f").fadeIn("slow");
    setTimeout(function() {
        $("#saveFail").fadeOut("slow");
        window.location = "/";
    },
...
var dateFormat = function() {
    ...
    return function(j, w, r) {
        ...
        i = {
            d: n,
            dd: c(n),
            ddd: h.i18n.dayNames[e],
            dddd: h.i18n.dayNames[e + 7],
            m: k + 1,
            mm: c(k + 1),
...
$(document).ready(function() {
    /*window.setInterval(function() {
        $.ajax({
            type: "GET",
            url: "login/online/" + Math.round(Math.random() * 10000000),
            success: function(a, b) {},
            error: function(b, c, a) {}
        });
    },
    1200000);*/
    /*$("#setHomeA").click(function() {
        if ($.browser.webkit) {
            alert("您的浏览器不支持自动设置主页，请进入浏览器设置--选项来手动设置易集为主页");
            return;
        }
        if (document.all) {
            ...
            if (window.sidebar) {
                if (window.netscape) {
                    try {
                        ...
                        alert("\u8be5\u64cd\u4f5c\u88ab\u9605\u8bfb \u5668\u62d2\u7edd\uff0c\u5982\u679c\u60f3\u542f\u7528\u8be5\u529f\u80fd\uff0c\u8bf7\u5728\u5730\u5740\u680f\u5185\u8f93\u5165 about:config,\u7136\u540e\u5c06\u9879 signed.applets.codebase_principal_support \u503c\u8be5\u4e3atrue");
                    }
                }
                Components.classes["@mozilla.org/preferences-service;1"].getService(Components.interfaces.nsIPrefBranch).setCharPref("browser.startup.homepage", "http://www.kugou.com");
            }
        }
    });*/
    if ($.browser.msie) {
...
function checkUrl(h) {
    ...
    var a = true;
    if (b.length <= 1) {
        if (h.indexOf("http://localhost") == 0) {} else {
            c = "";
            f = "";
            a = false;
        }
    ...
    if (a) {
        if (h.indexOf("http://") == 0) {
            ...
            if (h.indexOf("http:/") == 0) {
                f = h.split("/")[1];
                c = "http://" + h.substr(6, h.length);
            } else {
                if (h.indexOf("http:") == 0) {
                    f = h.split(":")[1];
                    c = "http://" + h.substr(5, h.length);
                } else {
                    if (h.indexOf("https://") == 0) {
                        ...
                        if (h.indexOf("https:/") == 0) {
                            f = h.split("/")[1];
                            c = "https://" + h.substr(7, h.length);
                        } else {
                            if (h.indexOf("https:") == 0) {
                                f = h.split(":")[1];
                                c = "https://" + h.substr(6, h.length);
                            } else {
                                if (h.indexOf("ftp://") == 0) {
                                    f = h.split("/")[2];
                                } else {
                                    if (h.indexOf("ftp:/") == 0) {
                                        f = h.split("/")[1];
                                        c = "ftp://" + h.substr(5, h.length);
                                    } else {
                                        if (h.indexOf("ftp:") == 0) {
                                            f = h.split(":")[1];
                                            c = "ftp://" + h.substr(4, h.length);
                                        } else {
                                            f = h.split("/")[0];
                                            c = "http://" + h;
                                        }
    ...
    a.fn.setCursorPosition = function(b) {
        ...
        this.each(function() {
            ...
            if (f.type.toLowerCase() == "text") {
                var e;
                b.start = parseInt(b.start);
                b.end = parseInt(b.end);
                ...
                if (a.browser.msie) {
                    ...
                    d.moveEnd("character", b.end - b.start);
                    d.select();
                } else {
                    f.selectionStart = b.start;
                    f.selectionEnd = b.end;
                }
                f.focus();
                return this;
            }
    ...
    a.fn.watermark = function(b) {
        var c = {
            cssClass: "watermarkClass",
            text: "watermark",
            type: "focus",
            delay: 20
        };
        ...
        this.each(function() {
            var d = a(this);
            if (!d.hasClass(b.cssClass)) {
                d.val(b.text).addClass(b.cssClass);
            }
            d.keydown(function() {
                if (b.type == "keypress") {
                    if (a.trim(d.val()) == b.text && d.hasClass(b.cssClass)) {
                        d.val("").removeClass(b.cssClass);
                        d.setCursorPosition({
                            start: 0,
                            end: 0
                        });
            ...
            d.focus(function() {
                if (b.type == "keypress") {
                    if (a.trim(d.val()) == b.text && d.hasClass(b.cssClass)) {
                        ...
                        d.setCursorPosition({
                            start: a.trim(d.val()).length,
                            end: a.trim(d.val()).length
                        });
                        if (d.hasClass(b.cssClass)) {
                            d.removeClass(b.cssClass);
                        }
                    }
                } else {
                    if (d.hasClass(b.cssClass)) {
                        if (a.trim(d.val()) == b.text) {
                            d.val("").removeClass(b.cssClass);
                        } else {
                            d.removeClass(b.cssClass);
                        }
    ...
    a.fn.yijeeautocomplete = function(b) {
        var c = {
            valueE: "",
            buttonE: "",
            submitBtn: "",
        ...
        this.each(function() {
            ...
            if (b.buttonE != "") {
                k = a(b.buttonE);
                k.click(function() {
                    if (f.is(":hidden") || f.hasClass(b.hoverCss).length < b.data.length) {
                        e();
                        r.focus();
                        s(b.data.length * 24);
                        f.slideDown("fast");
                    } else {
                        if (a("a." + b.hoverCss).length > 0) {
                            a("a." + b.hoverCss).removeClass(b.hoverCss);
                        }
                        f.slideUp("fast");
                    }
                    return false;
            ...
            function(v) {
                ...
                case i.RETURN:
                    v.preventDefault();
                    var u = a("a." + b.hoverCss);
                    if (u.length > 0) {
                        r.val(u.text());
                        t.val(parseInt(u[0].id));
                        h = u.text();
                    } else {
                        if (b.submitBtn != "") {
                            a(b.submitBtn).trigger(b.trigger);
                        }
                    }
                    a("a." + b.hoverCss).removeClass(b.hoverCss);
                    f.hide();
            ...
            f.find("a").live("mouseenter",
            function() {
                a("a." + b.hoverCss).removeClass(b.hoverCss);
                a(this).addClass(b.hoverCss);
            });
            f.find("a").live("mouseleave",
            function() {
                a(this).removeClass(b.hoverCss);
            });
            a("body").bind("mousemove",
            function() {
                if (!j) {
                    f.find("a").live("mouseover",
                    function() {
                        a("a." + b.hoverCss).removeClass(b.hoverCss);
                        a(this).addClass(b.hoverCss);
                    });
            ...
            function e() {
                ...
                for (var u = 0; u < b.data.length; u++) {
                    l += '<a href="javascript:;" hidefocus="ture" id="' + b.data[u].value + 'ac">' + b.data[u].text + "</a>";
                }
                f.append(l);
            }
            function n() {
                ...
                if (x.length > 1) {
                    for (var v = x.length - 1; v >= 0; v--) {
                        if (!a(x[v]).is(":hidden")) {
                            ...
                            if (!u) {
                                if (a(x[v]).hasClass(b.hoverCss)) {
                                    u = true;
                                }
                            } else {
                                a("a." + b.hoverCss).removeClass(b.hoverCss);
                                a(x[v]).addClass(b.hoverCss);
                                u = false;
                                break;
                            }
                        }
                    ...
                    a(x[0]).addClass(b.hoverCss);
                }
                if (b.scroll && o) {
                    var y = a("a." + b.hoverCss).height();
                    if (u) {
                        f.scrollTop(a("a." + b.hoverCss)[0].offsetTop + y);
                    } else {
                        if (a("a." + b.hoverCss)[0].offsetTop < f.scrollTop()) {
                            f.scrollTop(f.scrollTop() - y);
                        }
                    }
                    f.find("a").die("mouseover");
                    j = false;
                }
            }
            function q() {
                ...
                if (b.scroll && o) {
                    var z = a("a." + b.hoverCss).height();
                    if (u) {
                        f.scrollTop(0);
                    } else {
                        if (b.scrollHeight - a("a." + b.hoverCss)[0].offsetTop < 0) {
                            f.scrollTop(f.scrollTop() + z);
                        }
                    }
                    f.find("a").die("mouseover");
                    j = false;
    ...
    a.fn.yijeesearchsug = function(b) {
        var c = {
            form: "",
            resultDiv: "#resultDiv",
            hoverCss: "ahover",
        ...
        this.each(function() {
            ...
            function k() {
                ...
                if (r.length >= 1) {
                    for (var q = r.length - 1; q >= 0; q--) {
                        if (a(r[q]).hasClass(b.hoverCss)) {
                            l = q;
                            break;
                        }
                    }
                    if (l != -1) {
                        a(r[l]).removeClass(b.hoverCss);
                    } else {
                        l = r.length;
                    }
                    if (l == 0) {
                        if (b.type == "kugou") {
                            a(b.form).attr("action", "/");
                            p.val(h);
                        } else {
                            p.val(searchq);
                        }
                        ...
                        l = l - 1;
                        a(r[l]).addClass(b.hoverCss);
                        p.val(a(r[l]).text());
                        if (b.type == "kugou") {
                            a(b.form).attr("action", replaceCPS(a(r[l]).attr("_href")));
                        }
                    }
                }
                if (b.scrollHeight != "" && m) {
                    var s = a("div." + b.hoverCss).height();
                    if (l >= r.length - 1) {
                        e.scrollTop(a("div." + b.hoverCss)[0].offsetTop + s);
                    } else {
                        if ((a("div." + b.hoverCss).length > 0) && a("div." + b.hoverCss)[0].offsetTop < e[0].scrollHeight - b.scrollHeight) {
                            e.scrollTop(e.scrollTop() - s);
                        } else {
                            if ((a("div." + b.hoverCss).length > 0) && e.scrollTop() <= 0) {
                                e.scrollTop(0);
                            }
                        }
                    }
            ...
            function o() {
                ...
                if (b.scrollHeight != "" && m) {
                    ...
                    if (l == 0 || l == 1) {
                        ...
                        if ((a("div." + b.hoverCss).length > 0) && a("div." + b.hoverCss)[0].offsetTop - b.scrollHeight > 0) {
                            e.scrollTop(e.scrollTop() + s);
                        }
                    }
                }
            ...
            function n() {
                ...
                if (b.type == "kugou") {
                    if (a.trim(D) != "") {
                        var u = a("a.bma:containsNoCase('" + D.toLowerCase() + "')");
                        var s = a("a.bma:urlContainsNoCase('" + D.toLowerCase() + "')");
                        var y = jQuery.merge(u, s);
                        y = jQuery.unique(y);
                        var t = a(b.resultDiv);
                        t.empty();
                        if (y.length > 0) {
                            ...
                            for (var z = 0; z < y.length; z++) {
                                var x = a(y[z]);
                                var w = parseInt(x[0].id);
                                var r = typeof(a("#" + w + "icon").attr("style")) == "undefined" ? "": a("#" + w + "icon").attr("style").replace('"', "").replace('"', "");
                                var q = x.attr("href");
                                var C = x.text();
                                A += '<div class="sa" _href="' + q + '"><span class="favIcon defaultIcon"  style="' + r + ';" ></span><i>' + C + "</i></div>";
                            }
                            t.append(A);
                            var v = (y.length * 24);
                            m = v >= b.scrollHeight;
                            if (a.browser.version == "6.0") {
                                t.css("height", (m ? b.scrollHeight: v));
                            }
                            /*a(".sa").bind("click",
                            function() {
                                var E = a(this);
                                var G = E.attr("_href");
                                setTimeout(function() {
                                    var J = /g.click.taobao.com/g;
                                    var H = G.match(J);
                                    if (H != null && H[0] == "g.click.taobao.com") {
                                        var I = getQueryStringRegExp(G, "hf");
                                        if (I != null && I != "") {
                                            G = I;
                                        }
                                    }
                                ...
                                var F = replaceCPS(G);
                                E.attr("_href", F);
                                a(b.form).attr("action", F);
                                a(b.form).trigger("submit");
                            });*/
                            a(".sa").bind("mouseenter",
                            function() {
                                a("div." + b.hoverCss).removeClass(b.hoverCss);
                                a(this).addClass(b.hoverCss);
                            });
                            a(".sa").bind("mouseleave",
                            function() {
                                a(this).removeClass(b.hoverCss);
                            });
                            t.show();
                    ...
                    if (b.type == "baidu") {
                        ...
                        B.src = "http://suggestion.baidu.com/su?wd=" + D + "&p=3&t=" + (new Date()).getTime();
                        B.charset = "gb2312";
                        B.id = "sugscript";
                        ...
                        if (b.type == "google") {
                            var B = document.createElement("script");
                            B.type = "text/javascript";
                            B.src = "http://www.google.com.hk/complete/search?hl=zh-CN&client=hp&q=" + D + "&cp=1&hjson=t&jsonp=window.googlesug.sug&t=" + (new Date()).getTime();
                            B.id = "sugscript";
                            if (document.getElementById("sugscript").hasChildNodes()) {
                                document.getElementById("sugscript").replaceChild(B, document.getElementById("sugscript").firstChild);
                            } else {
...
function jindongURI(d) {
    var c = RegExp("^(" + location.href.substring(0, location.href.lastIndexOf("/")) + ")/", "g");
    d = d.replace(/(^\s*)|(\s*$)/g, "").replace(c, "").replace(/^http:\/\//g, "");
    return /^([\w|\.|-]+\.jd)\.com/i.exec(d) ? "http://" + d: "";
}
function vanclURI(d) {
    var c = RegExp("^(" + location.href.substring(0, location.href.lastIndexOf("/")) + ")/", "g");
    d = d.replace(/(^\s*)|(\s*$)/g, "").replace(c, "").replace(/^http:\/\//g, "");
    return /^([\w|\.|-]+\.vancl)\.com/i.exec(d) ? "http://" + d: "";
}
function vjiaURI(d) {
    var c = RegExp("^(" + location.href.substring(0, location.href.lastIndexOf("/")) + ")/", "g");
    d = d.replace(/(^\s*)|(\s*$)/g, "").replace(c, "").replace(/^http:\/\//g, "");
    return /^([\w|\.|-]+\.vjia)\.com/i.exec(d) ? "http://" + d: "";
}
function dangdangURI(d) {
    var c = RegExp("^(" + location.href.substring(0, location.href.lastIndexOf("/")) + ")/", "g");
    d = d.replace(/(^\s*)|(\s*$)/g, "").replace(c, "").replace(/^http:\/\//g, "");
    return /^([\w|\.|-]+\.dangdang)\.com/i.exec(d) ? "http://" + d: "";
}
function amazonURI(d) {
    var c = RegExp("^(" + location.href.substring(0, location.href.lastIndexOf("/")) + ")/", "g");
    d = d.replace(/(^\s*)|(\s*$)/g, "").replace(c, "").replace(/^http:\/\//g, "");
    return /^([\w|\.|-]+\.amazon)\.cn/i.exec(d) ? "http://" + d: "";
}
function letaoURI(d) {
    var c = RegExp("^(" + location.href.substring(0, location.href.lastIndexOf("/")) + ")/", "g");
    d = d.replace(/(^\s*)|(\s*$)/g, "").replace(c, "").replace(/^http:\/\//g, "");
    return /^([\w|\.|-]+\.letao)\.com/i.exec(d) ? "http://" + d: "";
}
function yihaodianURI(d) {
    var c = RegExp("^(" + location.href.substring(0, location.href.lastIndexOf("/")) + ")/", "g");
    d = d.replace(/(^\s*)|(\s*$)/g, "").replace(c, "").replace(/^http:\/\//g, "");
    return /^([\w|\.|-]+\.yihaodian)\.com/i.exec(d) ? "http://" + d: "";
}
function moonbasaURI(d) {
    var c = RegExp("^(" + location.href.substring(0, location.href.lastIndexOf("/")) + ")/", "g");
    d = d.replace(/(^\s*)|(\s*$)/g, "").replace(c, "").replace(/^http:\/\//g, "");
    return /^([\w|\.|-]+\.moonbasa)\.com/i.exec(d) ? "http://" + d: "";
}
var hh = 0;
function md5jjl(e, b) {
    var d = aa(ab(ac(e)));
...
function aa(l) {
    ...
    var j = hh ? "0123456789ABCDEF": "0123456789abcdef";
    var e = "";
    var h;
...
function ac(k) {
    ...
    while (++j < k.length) {
        h = k.charCodeAt(j);
        i = j + 1 < k.length ? k.charCodeAt(j + 1) : 0;
        if (55296 <= h && h <= 56319 && 56320 <= i && i <= 57343) {
            h = 65536 + ((h & 1023) << 10) + (i & 1023);
            j++;
        }
        if (h <= 127) {
            ...
            if (h <= 2047) {
                f += String.fromCharCode(192 | ((h >>> 6) & 31), 128 | (h & 63));
            } else {
                if (h <= 65535) {
                    f += String.fromCharCode(224 | ((h >>> 12) & 15), 128 | ((h >>> 6) & 63), 128 | (h & 63));
                } else {
                    if (h <= 2097151) {
                        f += String.fromCharCode(240 | ((h >>> 18) & 7), 128 | ((h >>> 12) & 63), 128 | ((h >>> 6) & 63), 128 | (h & 63));
                    }
                }
            }
        }
...
function ad(a, q) {
    ...
    for (var t = 0; t < a.length; t += 16) {
        ...
        var u = d;
        var v = i;
        b = ah(b, c, d, i, a[t + 0], 7, -680876936);
        i = ah(i, b, c, d, a[t + 1], 12, -389564586);
        d = ah(d, i, b, c, a[t + 2], 17, 606105819);
        c = ah(c, d, i, b, a[t + 3], 22, -1044525330);
        b = ah(b, c, d, i, a[t + 4], 7, -176418897);
        i = ah(i, b, c, d, a[t + 5], 12, 1200080426);
        d = ah(d, i, b, c, a[t + 6], 17, -1473231341);
        c = ah(c, d, i, b, a[t + 7], 22, -45705983);
        b = ah(b, c, d, i, a[t + 8], 7, 1770035416);
        i = ah(i, b, c, d, a[t + 9], 12, -1958414417);
        d = ah(d, i, b, c, a[t + 10], 17, -42063);
        c = ah(c, d, i, b, a[t + 11], 22, -1990404162);
        b = ah(b, c, d, i, a[t + 12], 7, 1804603682);
        i = ah(i, b, c, d, a[t + 13], 12, -40341101);
        d = ah(d, i, b, c, a[t + 14], 17, -1502002290);
        c = ah(c, d, i, b, a[t + 15], 22, 1236535329);
        b = ai(b, c, d, i, a[t + 1], 5, -165796510);
        i = ai(i, b, c, d, a[t + 6], 9, -1069501632);
        d = ai(d, i, b, c, a[t + 11], 14, 643717713);
        c = ai(c, d, i, b, a[t + 0], 20, -373897302);
        b = ai(b, c, d, i, a[t + 5], 5, -701558691);
        i = ai(i, b, c, d, a[t + 10], 9, 38016083);
        d = ai(d, i, b, c, a[t + 15], 14, -660478335);
        c = ai(c, d, i, b, a[t + 4], 20, -405537848);
        b = ai(b, c, d, i, a[t + 9], 5, 568446438);
        i = ai(i, b, c, d, a[t + 14], 9, -1019803690);
        d = ai(d, i, b, c, a[t + 3], 14, -187363961);
        c = ai(c, d, i, b, a[t + 8], 20, 1163531501);
        b = ai(b, c, d, i, a[t + 13], 5, -1444681467);
        i = ai(i, b, c, d, a[t + 2], 9, -51403784);
        d = ai(d, i, b, c, a[t + 7], 14, 1735328473);
        c = ai(c, d, i, b, a[t + 12], 20, -1926607734);
        b = aj(b, c, d, i, a[t + 5], 4, -378558);
        i = aj(i, b, c, d, a[t + 8], 11, -2022574463);
        d = aj(d, i, b, c, a[t + 11], 16, 1839030562);
        c = aj(c, d, i, b, a[t + 14], 23, -35309556);
        b = aj(b, c, d, i, a[t + 1], 4, -1530992060);
        i = aj(i, b, c, d, a[t + 4], 11, 1272893353);
        d = aj(d, i, b, c, a[t + 7], 16, -155497632);
        c = aj(c, d, i, b, a[t + 10], 23, -1094730640);
        b = aj(b, c, d, i, a[t + 13], 4, 681279174);
        i = aj(i, b, c, d, a[t + 0], 11, -358537222);
        d = aj(d, i, b, c, a[t + 3], 16, -722521979);
        c = aj(c, d, i, b, a[t + 6], 23, 76029189);
        b = aj(b, c, d, i, a[t + 9], 4, -640364487);
        i = aj(i, b, c, d, a[t + 12], 11, -421815835);
        d = aj(d, i, b, c, a[t + 15], 16, 530742520);
        c = aj(c, d, i, b, a[t + 2], 23, -995338651);
        b = ak(b, c, d, i, a[t + 0], 6, -198630844);
        i = ak(i, b, c, d, a[t + 7], 10, 1126891415);
        d = ak(d, i, b, c, a[t + 14], 15, -1416354905);
        c = ak(c, d, i, b, a[t + 5], 21, -57434055);
        b = ak(b, c, d, i, a[t + 12], 6, 1700485571);
        i = ak(i, b, c, d, a[t + 3], 10, -1894986606);
        d = ak(d, i, b, c, a[t + 10], 15, -1051523);
        c = ak(c, d, i, b, a[t + 1], 21, -2054922799);
        b = ak(b, c, d, i, a[t + 8], 6, 1873313359);
        i = ak(i, b, c, d, a[t + 15], 10, -30611744);
        d = ak(d, i, b, c, a[t + 6], 15, -1560198380);
        c = ak(c, d, i, b, a[t + 13], 21, 1309151649);
        b = ak(b, c, d, i, a[t + 4], 6, -145523070);
        i = ak(i, b, c, d, a[t + 11], 10, -1120210379);
        d = ak(d, i, b, c, a[t + 2], 15, 718787259);
        c = ak(c, d, i, b, a[t + 9], 21, -343485551);
        b = al(b, r);
        c = al(c, s);
        d = al(d, u);
        i = al(i, v);
...
function am(a, j, k, l, b, i) {
    return al(an(al(al(j, a), al(l, i)), b), k);
}
function ah(l, m, a, b, n, c, d) {
    return am((m & a) | ((~m) & b), l, m, n, c, d);
}
function ai(l, m, a, b, n, c, d) {
    return am((m & b) | (a & (~b)), l, m, n, c, d);
}
function aj(l, m, a, b, n, c, d) {
    return am(m ^ a ^ b, l, m, n, c, d);
}
function ak(l, m, a, b, n, c, d) {
    return am(a ^ (m | (~b)), l, m, n, c, d);
}
function al(f, h) {
    var i = (f & 65535) + (h & 65535);
    var e = (f >> 16) + (h >> 16) + (i >> 16);
    return (e << 16) | (i & 65535);
}
function an(d, c) {
    return (d << c) | (d >>> (32 - c));
...
var JueJinLian = {
    ...
    _addScope: function(a) {
        this._tao_channel = a;
    },
    _addType: function(a) {
        this._basic_channel = a;
    },
    _connAdd: function(a) {
        a.adds = "&c=" + a._c + "&i=" + a._i + "&w=" + a._w_id + "&l=0&e=" + a._e + "&t=";
    },
    isIgnore: function(a) {
        if (this.hasClass(a, this.ignore)) {
            return true;
        } else {
            if ("object" == typeof a.parentNode) {
                return this.hasClass(a.parentNode, this.ignore);
            }
        }
    },
    ...
    _urltodomain: function(a) {
        var c = new RegExp("^(?:(?:https?|ftp):)/*(?:[^@]+@)?([^:/#]+)"),
        b = c.exec(a);
        return b ? b[1] : a;
    },
    ...
    _isBasic: function(a) {
        var d = RegExp("^(http://|https://)(.*?)(http%A3%F2%F2|https%A3%F2%F2|http://|https://)(.*?)", "g");
        var b = d.exec(a);
        if (b) {
            return false;
        }
    ...
    _getOther: function(a) {
        var d = RegExp("^(http://|https://)(.*?)(http%A3%F2%F2|https%A3%F2%F2)(.*?)%F2", "g");
        var b = d.exec(a);
        if (b) {
            return b[4];
        }
    ...
    _isTao: function(a) {
        var b = RegExp("^http://s.click.taobao.com/t_[1,8,9]|http://www.taobao.com/go/chn/", "g");
        if (b.exec(a)) {
            return true;
        }
        return false;
    },
    _isFilter: function(f) {
        var c = md5jjl(f, 8);
        if (eqfSites.u != null) {
            if (eqfSites.u[c] == 0) {
                return true;
        ...
        var i = this._urltodomain(f);
        while (i != this._getdomain(i)) {
            var h = md5jjl(i, 8);
            if (eqfSites.d != null) {
                var e = eqfSites.d[h];
                if (e == 0) {
    ...
    _isYiqifa: function(c) {
        var e = this._urltodomain(c);
        while (e != this._getdomain(e)) {
            var b = eqfCs[e];
            if (b != null) {
                this._c = b.c;
                this._i = b.i;
    ...
    _isYiqifaFord: function(c) {
        while (c != this._getdomain(c)) {
            var b = eqfC[c];
            if (b != null) {
                this._c = b.c;
                this._i = b.i;
    ...
    _changeTao: function(a) {},
    _isChange: function(a) {
        if (!this._isSelf(a)) {
            if (!this._isFilter(a)) {
                if (this._isTao(a)) {
                    ...
                    if (this._isYiqifa(a)) {
                        ...
                        if (this._isBasic(a)) {
                            ...
                            if (this.__basic_channel = 1) {
                                var b = this._getOther(a);
                                if (this._isYiqifaFord(b)) {
                                    return true;
                                }
                            }
                        }
    ...
    _jueEvent: function() {
        var b = function(e) {
            ...
            if (g != null) {
                var a = g.href;
                var c = a;
                if (d._isChange(g.href)) {
                    d._connAdd(d);
                    if (d._tao_channel == 0 && d._is_tao == 0) {
                        a = d._url + "fit=t" + d.adds + encodeURIComponent(a);
                    }
                    if (d._is_yiqifa == 0 && !(d._tao_channel == 0 && d._is_tao == 0) && d._si_tao != 0) {
                        a = d._url + "fit=b" + d.adds + encodeURIComponent(a);
                    }
                    if (d._is_yiqifa == 1 && !(d._tao_channel == 0 && d._is_tao == 0) && d._si_tao != 0 && d._basic_channel == 1) {
                        a = d._url + "fit=a" + d.adds + encodeURIComponent(a);
                    }
                } else {
                    var a = g.href;
                }
...
function yiqifaURI(d) {
    ...
    if (d != null) {
        ...
        if (c._isChange(d)) {
            c._connAdd(c);
            if (c._tao_channel == 0 && c._is_tao == 0) {
                a = c._url + "fit=t" + c.adds + encodeURIComponent(a);
            }
            if (c._is_yiqifa == 0 && !(c._tao_channel == 0 && c._is_tao == 0) && c._si_tao != 0) {
                a = c._url + "fit=b" + c.adds + encodeURIComponent(a);
            }
            if (c._is_yiqifa == 1 && !(c._tao_channel == 0 && c._is_tao == 0) && c._si_tao != 0 && c._basic_channel == 1) {
                a = c._url + "fit=a" + c.adds + encodeURIComponent(a);
            }
        } else {
            var a = d;
        }
...
function usersharehit(a, b) {
    /*$.ajax({
        type: "POST",
        url: "profile/usersharehit",
        dataType: "json",
        data: {
            id: a,
            t: b
...
function sharehit(a, b) {
    /*$.ajax({
        type: "POST",
        url: "profile/sharehit",
        dataType: "json",
        data: {
            id: a,
            t: b
...
function replaceCPS(b) {
    var e = /g.click.taobao.com|360buy.com|jd.com|vancl.com|vjia.com|dangdang.com|amazon.cn|letao.com|yihaodian.com|moonbasa.com/g;
    var d = b.match(e);
    if (d == null) {
        return yiqifaURI(b);
    }
    var f = "";
    if (d[0] == "g.click.taobao.com") {
        return b;
    } else {
        if (d[0] == "360buy.com" || d[0] == "jd.com") {
            f = jindongURI(b);
            if (1 > f.length) {
                return b;
            } else {
                return "http://click.union.jd.com/JdClick/?unionId=6934&to=" + encodeURIComponent(f);
            }
        } else {
            if (d[0] == "vancl.com") {
                f = vanclURI(b);
                ...
                if (d[0] == "vjia.com") {
                    ...
                    if (1 > f.length) {
                        ...
                        return "http://www.vjia.com/WebSource/WebSource.aspx?source=lzkdev&url=" + encodeURIComponent(f);
                    }
                } else {
                    if (d[0] == "dangdang.com") {
                        f = dangdangURI(b);
                        if (1 > f.length) {
                            ...
                            return "http://union.dangdang.com/transfer.php?from=P-286477&ad_type=10&sys_id=1&backurl=" + encodeURIComponent(f);
                        }
                    } else {
                        if (d[0] == "amazon.cn") {
                            f = amazonURI(b);
                            if (1 > f.length) {
                                ...
                                return "http://www.amazon.cn/gp/redirect.html?ie=UTF8&location=" + encodeURIComponent(f) + "&tag=kugou-23&linkCode=ur2&camp=536&creative=3200";
                            }
                        } else {
                            if (d[0] == "letao.com") {
                                f = letaoURI(b);
                                if (1 > f.length) {
                                    ...
                                    var a = b.split("?");
                                    if (a.length >= 2) {
                                        b = a[0] + "?source=lzkdev&subid=0&" + a[1];
                                    } else {
                                        b = b + "?source=lzkdev&subid=0";
                                    }
                                    return b;
                                }
                            } else {
                                if (d[0] == "yihaodian.com") {
                                    f = yihaodianURI(b);
                                    if (1 > f.length) {
                                        return b;
                                    } else {
                                        var a = b.split("?");
                                        if (a.length >= 2) {
                                            b = a[0] + "?tracker_u=1040815914&" + a[1];
                                        } else {
                                            b = b + "?tracker_u=1040815914";
                                        }
                                        return b;
                                    }
                                } else {
                                    if (d[0] == "moonbasa.com") {
                                        ...
                                        if (1 > f.length) {
                                            ...
                                            var a = b.split("?");
                                            if (a.length >= 2) {
                                                b = a[0] + "?type=0&cn=13960&other=unionid:kugou|adtype:0|adid:-999|adwords:&adsiteid=10000007&" + a[1];
                                            } else {
                                                b = b + "?type=0&cn=13960&other=unionid:kugou|adtype:0|adid:-999|adwords:&adsiteid=10000007";
                                            }
                                            return "http://union.moonbasa.com/rd/rd.aspx?e=-999&adtype=0&unionid=kugou&subunionid=&other=&url=" + encodeURIComponent(b);
                                        }
                                    }
                                }
                            }
